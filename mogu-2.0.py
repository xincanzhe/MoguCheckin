...
# 打卡配置
device = "Android"  # 设备 iOS 或 Android
ltype = "android"  # 登录类型 ios 或 android
stype = "END"  # 上班 START 下班 END
phone = ""  # 账号
password = ""  # 密码
city = ""  # 城市
province = ""  # 省份
...
latitude = ""  # 纬度
address = ""  # 打卡位置
skey = ""  # Qmsg酱推送服务 https://sct.ftqq.com/ 填写获取到的 send_key
qq = ""
UA = "Mozilla/5.0 (Linux; U; Android 10; zh-cn; AQM-AL10 Build/HONORAQM-AL10) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Mobile Safari/533.1"
...
def push(_title, _desp):
    # time2 = re.findall("createTime\':\'(.*?)\'", _desp)
    # print(time2)
    send_url = "https://qmsg.zendee.cn:443/send/" + skey
    params = {"msg": _title, "qq": f'{qq}'}
    try:
